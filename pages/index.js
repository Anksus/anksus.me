      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="pt-6 pb-5 space-y-2 md:space-y-5">
          ...
          <p className="text-lg leading-7 text-gray-500 dark:text-gray-400">
            <span className="font-bold text-gray-700 dark:text-gray-100">Curious mind</span>
            ...
            with a knack for building things. I'm an 24-year-old from{' '}
            ...
            <span className="font-bold text-gray-700 dark:text-gray-100">
              {' '}
              <a href="https://www.gojek.io/">Gojek</a>
            </span>
            .
          </p>

          <div>
            <h1 className="text-3xl mt-14 font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-3xl sm:leading-10 md:text-4xl md:leading-14">
              Latest
            </h1>
          </div>
        </div>
